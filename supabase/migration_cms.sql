...
insert into site_content (section, content) values
  ...
  ('studio', '{"lead":"Evorya accompagne les entreprises dans la création d''une présence digitale moderne, crédible et mémorable.","body":"Nous ne créons pas simplement des pages web. Nous construisons une expérience pensée autour de votre entreprise, de votre clientèle et de votre identité.","tag":"PROJECT 001 — EVORYA"}'::jsonb),
